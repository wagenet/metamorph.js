...
(function(window) {
  ...
  // create the startTag HTML for the current metamorph. this function will be
  // extended by the Internet Explorer version to work around a bug.
  startTagFunc = function() {
    return "<script id='" + this.start + "' type='text/x-placeholder'></script>";
  };

  // create the endTag HTML for the current metamorph.
  endTagFunc = function() {
  ...
  if (supportsRange) {
     ...
     **/
    outerHTMLFunc = function() {
      return this.startTag(true) + this.innerHTML + this.endTag();
    };

    var startTagFuncWithoutShy = startTagFunc;

    startTagFunc = function(noShy) {
      return (noShy ? '' : "&shy;") + startTagFuncWithoutShy.call(this);
    }
